#SIH26132 SIH hackathon Problem statement - Strengthening market linkages and price discovery for farmers.
#Problem Description-
Description 
...
#Our inovation
Our SIH project focuses on Strengthening Market Linkages and Price Discovery for Farmers through three main features:

Live Price System – Uses reliable government data from platforms like eNAM to show current crop and mandi prices.
AI/ML Assistant – Analyzes prices and mandi data to help farmers decide when to sell, where to sell, and whether to hold their produce.
